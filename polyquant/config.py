...
class Settings(BaseSettings):
    ...
    paper_fee_bps:float=0.0;paper_slippage_bps:float=5.0
    auto_trade_enabled:bool=False;auto_interval_seconds:int=60;auto_order_notional:float=100.0;auto_max_trades_per_cycle:int=3;auto_allow_pyramiding:bool=False
    realtime_enabled:bool=True;realtime_prefer_sdk:bool=True;realtime_poll_seconds:float=5.0;realtime_stale_seconds:float=20.0;realtime_market_limit:int=20
